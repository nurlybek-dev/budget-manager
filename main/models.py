...
class Transaction(models.Model):
    user = models.ForeignKey(get_user_model(), on_delete=CASCADE, related_name='transactions')
    source = models.ForeignKey(Account, on_delete=CASCADE, related_name='source_transactions')
    destination = models.ForeignKey(Account, on_delete=CASCADE, related_name='destination_transactions')
